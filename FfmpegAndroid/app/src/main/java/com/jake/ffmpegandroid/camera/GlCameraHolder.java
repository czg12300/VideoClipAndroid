...
public class GlCameraHolder extends BaseCameraHolder {
    ...
    private CameraRenderer.OnRendererListener onRendererListener = new CameraRenderer.OnRendererListener() {
        @Override
        public void openRendererCamera() {
            onResume();
            final Camera.Size previewSize = mCamera.getParameters().getPreviewSize();
            mCameraRenderer.updateRotation(getCameraDisplayOrientation(), previewSize, isFacingFront());
